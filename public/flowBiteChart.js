    ...
    var C = {
                    ...
                    tooltip: {
                        shared: !1, followCursor: !0, custom: function (t) {
                            return t.w.config.plotOptions && t.w.config.plotOptions.bar && t.w.config.plotOptions.bar.horizontal ? function (t) {
                                var i = T(e(e({}, t), {}, {isTimeline: !0})), a = i.color, s = i.seriesName,
        ...
        return r(t, [{
            key: "getLabel", value: function (t, e, i, a) {
                var s = arguments.length > 4 && void 0 !== arguments[4] ? arguments[4] : [],
                    ...
                    d = n.config.xaxis.labels.formatter, g = !1, u = new M(this.ctx), p = l;
        ...
        return r(t, [{
            key: "niceScale", value: function (t, e) {
                var i = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : 0, a = 1e-11, s = this.w,
                    r = s.globals, o = s.config.xaxis, n = s.config.yaxis[i], l = void 0 !== n.min && null !== n.min,
                    h = void 0 !== n.max && null !== n.min, c = void 0 !== n.stepSize && null !== n.stepSize,
                    d = void 0 !== n.tickAmount && null !== n.tickAmount,
                    g = ((r.isBarHorizontal ? r.svgWidth : r.svgHeight) - 100) / 15, u = d ? n.tickAmount : 10;
                ...
                if (n.forceNiceScale) {
                    !l && t > 0 && t / v < .15 && (t = 0, l = !0), !h && e < 0 && -e / v < .15 && (e = 0, h = !0), v = Math.abs(e - t)
                }
                ...
                if (m = y = (A = r.niceScaleAllowedMagMsd[0 === r.yValueDecimal ? 0 : 1][A]) * k, r.isBarHorizontal && o.stepSize && "datetime" !== o.type ? (m = o.stepSize, c = !0) : c && (m = n.stepSize), c && n.forceNiceScale && Math.round(Math.log10(m)) != w) {
                    for (var S = v / u; m < S;) m *= 10;
                    for (; m > S;) m /= 10
                }
                if (l && h) {
                    var C = v / b;
                    if (d) if (c) if (0 != x.mod(v, m)) {
                        var L = x.getGCD(m, C);
                        m = C / L < 10 ? L : C
                    } else 0 == x.mod(m, C) ? m = C : (C = m, d = !1); else m = C; else if (c) 0 == x.mod(v, m) ? C = m : m = C; else if (C = v / (b = Math.round(v / y)), 0 != x.mod(v, m)) {
                        var P = x.getGCD(v, y);
                        y / P < 10 && (C = P), m = C
                    } else C = m;
                    b = Math.round(v / m)
                } else {
                    if (l || h) h ? t = d ? e - m * b : m * Math.floor(t / m) : l && (e = d ? t + m * b : m * Math.ceil(e / m)); else if (d) {
                        var I = m / (e - t > e ? 1 : 2);
                ...
                if (d || l || h || (b = Math.ceil((v - a) / (m + a))) > 16 && x.getPrimeFactors(b).length < 2 && b++, r.isMultipleYAxis && 0 == r.multiAxisTickAmount && (r.multiAxisTickAmount = b), b > g && (!d && !c || n.forceNiceScale)) {
                    ...
                    t:for (var X = 0; X < T; X++) for (var E = 0; E <= T - X; E++) {
                        for (var Y = Math.min(E + X, T), F = z, R = 1, H = E; H <= Y; H++) R *= M[H];
                        if ((F /= R) < g) {
                            z = F;
                            break t
                        }
        ...
        return r(t, [{
            ...
            key: "getMinYMaxY", value: function (t) {
                ...
                if (r.seriesX.length >= a) {
                    var d;
                    if (l = 0, h = (c = u(new Set((d = []).concat.apply(d, u(r.seriesX.slice(t, a)))))).length - 1, s.xaxis.min) for (l = 0; l < h && c[l] <= s.xaxis.min; l++) ;
            ...
            key: "create", value: function (t, i, a, s, r) {
                ...
                if (S.config.legend.tooltipHoverFormatter) {
                    ...
                    for (var T = 0; T < M.length; T++) {
                        var z = M[T], X = parseInt(z.getAttribute("i"), 10),
            ...
            key: "draw", value: function (t, i) {
                ...
                for (var n = 0, l = 0; n < t.length; n++, l++) {
                    ...
                    for (var I = 0; I < t[n].length; I++) {
                        var M = this.barHelpers.getStrokeWidth(n, I, v), T = null,
                            z = {indexes: {i: n, j: I, realIndex: v, bc: l}, x: u, y: p, strokeWidth: M, elSeries: w};
                ...
                for (var r = s.group({class: "apexcharts-rangebar-series apexcharts-plot-series"}), n = 0; n < t.length; n++) {
                    ...
                    for (var w = s.group({
                        ...
                        var S, C = this.barHelpers.getStrokeWidth(n, A, p), L = this.seriesRangeStart[n][A],
                            P = this.seriesRangeEnd[n][A], I = null, M = null, T = null,
    ...
    var Ft = function () {
        ...
        return r(t, [{
            key: "draw", value: function (t, i, a, s) {
                ...
                })), o.config.chart.stacked) for (var T = d.length; T > 0; T--) h.add(d[T - 1]); else for (var z = 0; z < d.length; z++) h.add(d[z]);
                return h
            }
        }, {
            ...
            key: "_iterateOverDataPoints", value: function (t) {
                var e, i = this, a = t.type, s = t.series, r = t.iterations, o = t.realIndex, n = t.i, l = t.x, h = t.y,
                    ...
                    M = g.areaPath, T = g.pathFromLine, z = g.pathFromArea,
                ...
                case"A":
                    e = function (t, e) {
                        var i, a, s, r, o, n, l, h, c, d, g, u, p, f, x, b, v, m, y, w, k, A, S, C, L, P,
                            I = Math.abs(e[1]), M = Math.abs(e[2]), T = e[3] % 360, z = e[4], X = e[5], E = e[6],
