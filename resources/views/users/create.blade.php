        ...
        <div class="p-4 mb-4 sm:p-8 bg-white dark:bg-gray-800 drop-shadow-md sm:rounded-lg">
            <div class="grid grid-cols-1 md:grid-cols-4 gap-4 py-2">
                ...
                <div>
                    ...
                    <x-text-input name="full_name" id="full_name" value="{{old('full_name')}}" class="block" type="text" autofocus/>
                    <x-input-error :messages="$errors->get('full_name')"/>
                </div>
                <div>
                    <x-input-label for="p_code" :value="__('شماره پرسنلی')"/>
                    <x-text-input name="p_code" id="p_code" value="{{old('p_code')}}" class="block" type="text" maxlength="6" autofocus/>
                    <x-input-error :messages="$errors->get('p_code')"/>
                </div>
                <div>
                    <x-input-label for="n_code" :value="__('کد ملی')"/>
                    <x-text-input name="n_code" id="n_code" value="{{old('n_code')}}" class="block" type="text" maxlength="10" autofocus/>
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-4 py-2">
                <div>
                    ...
                    <x-text-input name="phone" id="phone" value="{{old('phone')}}" class="block" type="text" maxlength="11" autofocus/>
                    <x-input-error :messages="$errors->get('phone')"/>
                </div>
                <div>
                    <x-input-label for="house_phone" :value="__('تلفن منزل')"/>
                    <x-text-input name="house_phone" id="house_phone" value="{{old('house_phone')}}" class="block" type="text" autofocus/>
                    <x-input-error :messages="$errors->get('house_phone')"/>
                </div>
                <div>
                    <x-input-label for="work_phone" :value="__('تلفن محل کار')"/>
                    <x-text-input name="work_phone" id="work_phone" value="{{old('work_phone')}}" class="block" type="text" autofocus/>
                    <x-input-error :messages="$errors->get('work_phone')"/>
                </div>
                <div>
                    <x-input-label for="position" :value="__('سمت')"/>
                    <x-text-input name="position" id="position" value="{{old('position')}}" class="block" type="text" autofocus/>
