<button {{ $attributes->merge(['type' => 'submit', 'class' => 'inline-flex items-center hover:ring-2
 hover:ring-gray-800 hover:ring-offset-2
   border border-transparent rounded-md font-semibold text-xs uppercase transition ease-in-out duration-300
 border-[#990302] hover:border-transparent
  px-4 py-2 bg-gray-800 dark:bg-gray-200
 font-semibold text-xs text-white dark:text-gray-800 uppercase hover:bg-gray-700 dark:hover:bg-white
