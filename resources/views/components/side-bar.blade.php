...
<ul class="w-full mt-2">
    <li class="space-y-2">
        <x-link.responsive-link wire:navigate.hover href="{{Illuminate\Support\Facades\URL::signedRoute('profile')}}"
        ...
        <x-link.responsive-link href="{{route('dashboard.meeting')}}" wire:navigate
        ...
        <x-link.responsive-link wire:navigate.hover href="{{route('employee.organization')}}"
                                :active="request()->is('employee/organization')" class="flex items-center gap-x-2">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-5">
        ...
        <x-link.responsive-link href="{{route('blogs.index')}}" wire:navigate wire:cloak
        ...
        <x-link.responsive-link href="{{route('phone-list.index')}}" wire:navigate wire:cloak
