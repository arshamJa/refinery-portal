...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'value'=>'ارزش',
        'categoryId' => 'گروه' ,
        'editingNewImages' => 'عکس',
        'editingNewPrice' => 'قیمت',
        'editingNewQuantity' => 'تعداد',
        'editingNewMessage' => 'توضیحات',
        'editingNewValue' => 'ارزش',
        'editingNewDiscount' => 'تخفیف',
        'subCategoryId' => 'زیر مجموعه' ,
        'f_name' => 'نام',
        'l_name' => 'نام خوانوادگی',
        'n_code' => 'کد ملی',
        'mobile' => 'موبایل',
        'skill' => 'مهارت',
        'code' => 'کد استاندارد',
        ...
        'department' => 'گروه',
        'departmentId' => 'گروه',
        'organizationName' => 'نام سامانه',
        'organizationUrl' => 'لینک سامانه',
        'orgName' => 'نام سامانه',
        'orgUrl' => 'لینک سامانه',
        'image' => 'عکس',
        'selectedOrganizations' => 'انتخاب سامانه',
        'selectedDep' => 'انتخاب دپارتمان',
        'organization' => 'سامانه',
        'url' => 'لینک سامانه',
        'excel_file' => 'فایل اکسل',
        'full_name' => 'نام و نام خانوداگی',
        'house_phone' => 'شماره منزل',
        'work_phone' => 'شماره محل کار',
        'position' => 'سمت',
        'unit' => 'واحد',
        'role' => 'نقش',
        'title' => 'عنوان',
        'body' => 'متن',
        'selectedOrganization' => 'انتخاب سامانه',
        'selectedDepartment' => 'انتخاب دپارتمان',
        'newPhone' => 'تلفن همراه',
        'newHousePhone' => 'تلفن منزل',
        'newWorkPhone' => 'تلفن محل کار',
        'unit_organization' => 'انتخاب واحد سازمانی',
        'scriptorium' => 'دبیر جلسه',
        'location' => 'مکان',
        'date' => 'تاریخ',
        'time' => 'زمان',
        'unit_held' => 'واحد برگزار کننده',
        'holders' => 'اعضای جلسه',
        'treat' => 'پذیرایی',
        'guest' => 'مهمان',
        'position_organization' => 'سمت سازمانی',
