...
use App\Livewire\admin\DepOrgConnection;
use App\Livewire\admin\organizationManage;
...
Route::middleware(['auth', 'adminMiddleware'])->group(function () {
    ...
    Route::post('/departments/organizations', [DepOrgConnectionController::class, 'store'])
